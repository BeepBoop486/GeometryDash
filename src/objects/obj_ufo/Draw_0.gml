...
draw_sprite_ext(spr_cube_01, 0, x, y, cscale, cscale*gravdir, angle*gravdir+angleplus,col1, image_alpha)
draw_sprite_ext(spr_player_02, 0, x, y, cscale, cscale*gravdir, angle*gravdir+angleplus, col2, image_alpha)
